...
// Port B
#define __LCD_CS_MASK (1 << 9)
#define __LCD_DC_MASK (1 << 5)
...
// Port D
#define __LCD_RST_MASK (1 << 11)
#define __LCD_WR_MASK (1 << 4)
#define __LCD_RD_MASK (1 << 5)
...
// Port E
#define __LCD_D0_NUM (0)
#define __LCD_D1_NUM (1)
#define __LCD_D2_NUM (2)
#define __LCD_D3_NUM (3)
#define __LCD_D4_NUM (4)
#define __LCD_D5_NUM (5)
#define __LCD_D6_NUM (6)
#define __LCD_D7_NUM (7)
